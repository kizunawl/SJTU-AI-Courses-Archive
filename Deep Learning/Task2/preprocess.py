...
def load():
    ...
    train_img = np.reshape(np.array(train_img), (-1, 3, 32, 32))
    ...
    train_img = np.reshape(np.array(train_img, dtype=np.float32), (-1, batchsize, 3, 32, 32))
    train_label = np.reshape(np.array(train_label), (-1, batchsize))
    test_img = np.reshape(np.array(test_img, dtype=np.float32), (-1, batchsize, 3, 32, 32))
